...
#
# Generated by export_simulation on Tue Feb 24 11:12:00 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './verif_data_packet_write.sh' script.

./verif_data_packet_write.sh -reset_run
...
./verif_data_packet_write.sh -noclean_files

For more information on the script, please type './verif_data_packet_write.sh -help'.
